...
class Http2ClientConnectionCustom implements connection.ClientConnection {
  ...
  Http2ClientConnectionCustom(
      Object host, int port, this.options, this._metadataDelegate)
  ...
  void dispatchCall(ClientCall call) async {
    ...
    if (_metadataDelegate != null) {
      call.options = CallOptions(
        metadata: (await _metadataDelegate())..addAll(call.options.metadata),
